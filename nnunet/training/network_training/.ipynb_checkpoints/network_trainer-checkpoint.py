...
class NetworkTrainer(object):
    ...
    def run_training(self):
        ...
        while self.epoch < self.max_num_epochs:
            ...
            if self.epoch%500 == 0:
                shutil.copyfile(join(self.output_folder, "model_best.model"),join(self.output_folder, "model_best_epoch{}.model".format(self.epoch)))
                shutil.copyfile(join(self.output_folder, "model_best.model.pkl"),join(self.output_folder, "model_best_epoch{}.model.pkl".format(self.epoch)))

        self.epoch -= 1  # if we don't do this we can get a problem with loading model_final_checkpoint.

        ## adding the save model per 500 epoch write by WX
